...
public class JdbcTeacherDao implements TeacherDao {
  ...
  public Teacher findByNo(int no) {
    try (Connection con = DriverManager.getConnection(
        ...
        Statement stmt = con.createStatement();
        ResultSet rs = stmt.executeQuery(
            "select teacher_id, name, tel, email, degree, school, "
                + "major, wage, created_date "
  ...
  public void update(Teacher t) {
    try (Connection con = DriverManager.getConnection(
      ...
      String sql = String.format(
          "update app_teacher set name='%s', tel='%s', email='%s', degree='%d', school='%s', "
              + "major=%s, wage='%d' where teacher_id=%d",
              t.getName(), t.getTel(), t.getEmail(), t.getDegree(), t.getSchool(), t.getMajor(), t.getWage());
  ...
  public boolean delete(Teacher t) {
    try (Connection con = DriverManager.getConnection(
      ...
      String sql = String.format("delete from app_teacher where teacher_id=%d",
          t.getNo());
